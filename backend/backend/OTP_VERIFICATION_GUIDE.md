...
Visit **https://srv1133545.hstgr.cloud/docs** (or `http://localhost:8000/docs` for local testing) and look for the **"otp-verification"** section to test all endpoints interactively.
